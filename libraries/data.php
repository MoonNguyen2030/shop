<?php 
...

    {
...

        {
            ...
            $this->link = mysqli_connect("localhost","root","","secondhand") or die ();
        ...
        public  function fetchPages($table,$sql,$total = 1,$page,$row ,$pagi = true )
    ...
    {   
...

        {
            ...
            $result = mysqli_query($this->link,$sql) or die("Lỗi truy vấn fetchPages ---- " .mysqli_error($this->link));
        ...
        public  function fetchPage($table,$sql ,$page = 0,$row ,$pagi = false )
    ...
    {       
...

        {
            ...
            $result = mysqli_query($this->link,$sql) or die("Lỗi truy vấn fetchPage ---- " .mysqli_error($this->link));
